...
extern "C" _declspec(dllexport) BOOL    NVisionDll_LoadImageFromFile(char *strPathName, unsigned char *fmImage, long nWidth, long nHeight, long nBand, long nDepth);
extern "C" _declspec(dllexport) BOOL    NVisionDll_SaveImageToFile(char *strPathName, LPBYTE fmImage, long nWidth, long nHeight, long nBand, long nDepth);
